    ...
    <div className="container">
      ...
      <div className="page">
        ...
        <p>
          ...
          improve performance, strengthen security, and enhance user experience.
        </p>
        {/*  Software Development Engineer with 3+ years of experience specializing */}
        in React Native, building scalable mobile applications used by 100K+
        users. Strong expertise in performance optimization, real-time systems,
        and end-to-end app development across mobile, web, and backend using
        React Native, Next.js, and Node.js.
        {/*  MARK:- Achievements */}
        <h2>ACHIEVEMENTS</h2>
        <ul>
          <li>
            Built and delivered 20+ mobile and web applications across iOS,
            Android, and web.
          </li>
          <li>
          ...
          <li>
            Developed real-time and AI-powered features improving engagement by
            and retention.
          </li>
          <li>
            Experience in CI/CD pipelines, scalable architecture, and mentoring
            developers.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Developed and maintained scalable features using Expo, React Native,
            Supabase, Node.js and backend services improved application
          ...
          <li>
            Optimized API calls and state management, reducing load times by 20%
            and improving app responsiveness
          </li>
          <li>
        ...
        <ul>
          <li>
            Successfully developed and deployed over 15 mobile applications
          ...
          <li>
            Conducted regular code reviews, ensuring adherence to best practices
        ...
        <p>
          ...
          Stripe, Razorpay, Firebase Auth, Cloud Messaging, Push Notifications,
          Google Vision API
        </p>
      </div>
      ...
      <div className="page">
        ...
        <ul>
          ...
          <li>
            Developed advanced functionalities such as AI-powered study material
            generation, text-to-speech (TTS), mock tests, and flashcards.
          </li>
          <li>
        ...
        <ul>
          <li>
            Reached 160K+ downloads by developing an AI-powered storytelling app
            for children (ages 3+) on the Google Play Store.
          </li>
          <li>
            Led end-to-end development using React Native, Firebase, and backend
            APIs, ensuring scalability and smooth UX.
          </li>
          <li>
        ...
        <ul>
          <li>
            Published React Native libraries used for developer productivity and
            app features (react-native-dynamic-shortcut, react-native-pip-mode,
            toast-react-native etc.)
          </li>
          <li>
