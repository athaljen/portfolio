...
import gmKlangApp from '../../assets/projects/gm-klang-app.png'
...
const projectsData: ProjectDataType[] = [
  {
    ...
    image: tnnhis,
    android_link:
      'https://play.google.com/store/apps/details?id=com.tnnhis.mobileapp',
    ios_link:
      'https://apps.apple.com/in/app/tnnhis/id1616444418?platform=iphone',
    website: '',
  },
  {
    title: 'Kahani Kids',
    ...
    image: kahaniKids,
    android_link:
      'https://play.google.com/store/apps/details?id=com.kahanikids.app',
    ios_link:
      'https://apps.apple.com/in/app/kahani-kids-storytelling-app/id1616444418?platform=iphone',
    website: '',
  },
  {
    ...
    ios_link:
      'https://apps.apple.com/us/app/f-f-bargains-shopping-deals/id6475801351',
    website: 'https://www.ffbargains.com',
  },
  {
    title: 'F&F Bargains, E-commerce',
    ...
    techStack: ['React', 'Redux', 'Firebase', 'Node.js'],
    image: ffBargainsWeb,
    android_link: '',
    ios_link: '',
  ...
  },
  {
    ...
    date: 'june 2023 - august 2023',
    description:
      'GM Klang is a music streaming web application that offers users access to a vast library of songs, albums, and playlists. The app provides features such as personalized recommendations, offline listening, and social sharing. GM Klang aims to enhance the music listening experience by providing a user-friendly interface and high-quality audio streaming.',
    contributions: ['I have made the project from scratch'],
  ...
  },
  {
    ...
    ios_link:
      'https://apps.apple.com/in/app/aap-ka-bazar-online-grocery/id1640031723',
    website: '',
  },
  {
    title: 'Iyal App',
